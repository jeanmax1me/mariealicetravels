  ...
  return (
    <div className={`font-mts bg-gradient-to-r ${currentTheme.gradient} relative`}>
      <div className="container mx-auto text-white py-12">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4">{currentTheme.title}</h1>
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2">{currentTheme.subtitle}</h2>
